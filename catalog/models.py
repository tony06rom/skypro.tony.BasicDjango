...
class Category(models.Model):
    ...
    description = models.TextField(blank=True, null=True, verbose_name='Описание',
                                   help_text='Внесите описание категории')
...
class Product(models.Model):
    ...
    description = models.TextField(blank=True, null=True, verbose_name='Описание',
                                   help_text='Внесите описание продукта')
    image = models.ImageField(upload_to='data/media/product_images', blank=True, null=True, verbose_name='Изображение')
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='products', blank=True, null=True, max_length=150,
                                 verbose_name='Категория', help_text='Внесите название категории продукта')
